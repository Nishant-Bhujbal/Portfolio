...
import '../globals/app_links.dart';
import '../globals/app_descriptions.dart';
...
class _MyPortfolioState extends State<MyPortfolio> {
  ...
  List gitlinks = <String>[
    Applinks.Zchat,
    Applinks.recipefinder,
    Applinks.tictactoe,
    Applinks.shelter,
  ];
  List descriptions = <String>[
    AppDescriptions.zchatdesc,
    AppDescriptions.recipedesc,
    AppDescriptions.ticdesc,
    AppDescriptions.Adoptdesc,
  ];
